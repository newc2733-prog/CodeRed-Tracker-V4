...
import { FlaskConical, Clock, Package, AlertCircle, ArrowLeft } from "lucide-react";
                  ...
                  <Card key={codeRed.id} className="border-yellow-300 bg-yellow-100">
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-semibold text-yellow-800">Code Red #{codeRed.id}</span>
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Lab Dashboard</h1>
                <p className="text-sm text-gray-600">Code Red Active - {activeCodeRed.labType} ({activeCodeRed.location})</p>
              </div>
            </div>
            <div className="text-right">
              <div className="text-sm text-gray-600">Current Time</div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Additional Code Red Activation */}
          <Card className="bg-green-50 border-green-200">
            ...
            <CardContent>
              <p className="text-sm text-green-700 mb-4">
                Start a new Code Red event alongside this one for multiple simultaneous cases
              </p>
              <Dialog>
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader>
                    <DialogTitle>Activate Additional Code Red</DialogTitle>
                  </DialogHeader>
                  <ActionButtons onRefetch={() => {
                    refetch();
                    refetchAll();
                  }} />
                </DialogContent>
