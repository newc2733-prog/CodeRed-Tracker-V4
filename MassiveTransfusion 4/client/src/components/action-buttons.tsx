      ...
      <div className="mt-8 flex justify-center">
        <Dialog open={isActivateOpen} onOpenChange={setIsActivateOpen}>
          <DialogTrigger asChild>
            <Button 
              size="lg"
              className="medical-red hover:bg-red-700 text-white px-8 py-4 text-lg"
            >
      ...
      <Dialog open={isDeactivateOpen} onOpenChange={setIsDeactivateOpen}>
        ...
        <DialogContent>
          ...
          <p className="text-sm text-gray-600 mb-4">
            Are you sure you want to deactivate the Code Red? This will end the massive transfusion protocol.
          </p>
      ...
      <Dialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
        ...
        <DialogContent>
          ...
          <p className="text-sm text-gray-600 mb-4">
            ...
            Use this only if the Code Red was activated in error. All associated blood packs will also be deleted.
          </p>
          <div className="flex justify-end space-x-2">
